...
public:
    ...
    /**
     * @brief  add edge for ODO pre-integration constraint from ODO measurement
     * @param  vertex_index_i, vertex ID of previous key frame
     * @param  vertex_index_j, vertex ID of current key frame
     * @param  imu_pre_integration, ODO pre-integration measurement
     * @return void
     */
